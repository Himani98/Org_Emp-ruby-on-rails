...
class OrganisationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post organisations_url, params: { organisation: { city: @organisation.city, emp_id: @organisation.emp_id, name: @organisation.name, phone: @organisation.phone } }
    end
  ...
  test "should update organisation" do
    patch organisation_url(@organisation), params: { organisation: { city: @organisation.city, emp_id: @organisation.emp_id, name: @organisation.name, phone: @organisation.phone } }
